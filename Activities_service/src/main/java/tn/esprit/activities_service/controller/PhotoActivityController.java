...
public class PhotoActivityController {
    ...
    public ResponseEntity<PhotoActivity> getPhotoActivityById(
            @Parameter(description = "ID de l'activité photo à récupérer") @PathVariable Long id) {
    ...
    public ResponseEntity<PhotoActivity> updatePhotoActivity(
            @Parameter(description = "ID de l'activité photo à mettre à jour") @PathVariable Long id,
    ...
    public ResponseEntity<Void> deletePhotoActivity(
            @Parameter(description = "ID de l'activité photo à supprimer") @PathVariable Long id) {
    ...
    public ResponseEntity<List<PhotoActivity>> getPhotoActivitiesByDifficulty(
            @Parameter(description = "Difficulté des activités") @PathVariable String difficulty) {
